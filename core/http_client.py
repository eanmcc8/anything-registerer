"""General-purpose HTTP client - based on curl_cffi, supports proxies, retries, session management"""
"""
HTTP client wrapper
HTTP request wrapper based on curl_cffi, supports proxies and error handling
"""
