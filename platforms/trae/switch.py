...
def switch_trae_account(
    ...
    try:
        ...
        return True, "Switch successful, please restart Trae IDE for new account to take effect"
...
def restart_trae_ide() -> Tuple[bool, str]:
    ...
    try:
        if system == "Darwin":  # macOS
            ...
            return True, "Trae IDE closed (app path not found, please start manually)"
